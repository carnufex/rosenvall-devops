...
public sealed record BoardAiContextDto(Guid BoardId, string Instructions, IReadOnlyList<string> EnabledSkills, bool AskWhenUncertain, string AgentInstructions = "", string? Provider = null);
...
public sealed record ReleaseDiagnosticsDto(string Version, string CommitSha, string BuildTimestamp, string ApiImage, string FrontendImage, string RunnerImage, string ConfigurationMode);
...
public sealed record BoardAiContextRequest(string? Instructions, IReadOnlyList<string>? EnabledSkills, bool? AskWhenUncertain, string? AgentInstructions = null, string? Provider = null);
