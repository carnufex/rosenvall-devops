...
public sealed record ApiStatusDto(string AuthMode, ApiResourceDiagnosticsDto Resources, CorsDiagnosticsDto Cors, LocalGitReadinessDto? LocalGit = null, DemoSandboxPolicyDto? DemoSandboxPolicy = null);
